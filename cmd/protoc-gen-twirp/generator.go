...
import (
	...
	"sniper-api/cmd/protoc-gen-twirp/internal/gen"
	"sniper-api/cmd/protoc-gen-twirp/internal/gen/stringutils"
	"sniper-api/cmd/protoc-gen-twirp/internal/gen/typemap"
...
func (t *twirp) generateImports(file *descriptor.FileDescriptorProto) {
	...
	t.P(`import `, t.pkgs["twirp"], ` "kingstar-go/sniper/twirp"`)
	t.P()
